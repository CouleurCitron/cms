    ...
    <div class="arbo_col_droite">
     ...
     ?>
      <tr class="<?php echo htmlImpairePaire($k);?>">
        ...
        if (preg_match("/swf/msi",$composant['type'])){ ?><a href="flashEditor.php?<?php echo $sParam; ?>id=<?php echo $composant['id'];?>&idSite=<?php echo $idSite; ?>&minisite=<?php echo $_GET['minisite']; ?>"><img src="/backoffice/cms/img/2013/icone/modifier.png" border="0" title="Modifier la brique"></a><?php } 
        elseif (preg_match("/video/msi",$composant['type'])){ ?><a href="videoEditor.php?<?php echo $sParam; ?>id=<?php echo $composant['id'];?>&idSite=<?php echo $idSite; ?>&minisite=<?php echo $_GET['minisite']; ?>"><img src="/backoffice/cms/img/2013/icone/modifier.png" border="0" title="Modifier la brique"></a><?php } 
