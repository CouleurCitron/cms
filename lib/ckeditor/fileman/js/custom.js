...
function FileSelected(file){
  ...
  //FileUpload multiple
  if(RoxyUtils.GetUrlParam('multiple')) {
    window.opener.SetUrl(file.fullPath, "30" , "20", RoxyUtils.GetUrlParam('idField'));
  } else {
    opener.document.getElementById(RoxyUtils.GetUrlParam('idField')).value = file.fullPath;
  }
