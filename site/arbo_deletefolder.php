...
Revision 1.1  2013-09-30 09:43:08  raphael
*** empty log message ***
...
Revision 1.6  2008-07-16 12:43:07  pierre
*** empty log message ***
...
if(!strlen($_POST['v_comp_path'])) {
	...
	if ($isMinisite) $id_minisite = deleteMinisite($idSite, $virtualPath); 	
...
<span class="arbo3">Supprimer un dossier&nbsp;>&nbsp;</span>
...
?></td>
      ...
      <td width="5"  align="left" valign="top" class="arbo"><img src="/backoffice/cms/img/vide.gif" width="15"></td>
      <td  align="left" valign="top" class="arbo">
        <!-- contenu des actions -->
        <?php
	if(!strlen($_POST['v_comp_path'])&&$virtualPath != "0") {
?>
        <u><b><br />
      ...
      <table border="1" cellpadding="5" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr align="center" bgcolor="EEEEEE">
          <td colspan="2" bgcolor="D2D2D2" class="arbo"><a href="pageArbo.php?menuOpen=<?php echo $_GET['menuOpen']; ?>" class="arbo"><strong>Annuler</strong></a>&nbsp;&nbsp;<a href="pageArbo.php?menuOpen=<?php echo $_GET['menuOpen']; ?>" class="arbo"><img border="0" src="<?php echo $URL_ROOT; ?>/backoffice/cms/img/2013/icone/go.png"></a> 
              - <a href="#" class="arbo" onClick="javascript:document.forms['managetree'].submit();"><strong>Supprimer le dossier</strong></a>&nbsp;&nbsp;<a href="#" onClick="javascript:document.forms['managetree'].submit();" class="arbo"><img border="0" src="<?php echo $URL_ROOT; ?>/backoffice/cms/img/2013/icone/go.png"></a></td>
        </tr>
      </table>
      <br />
      <?php
