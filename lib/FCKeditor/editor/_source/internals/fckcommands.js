...
FCKCommands.GetCommand = function( commandName )
{
	...
	switch ( commandName )
	{
		...
		case 'Glossary'		: oCommand = new FCKDialogCommand( 'Glossary'		, FCKLang.DlgGlossaryTitle	, 'dialog/fck_glossary.php'		, 500, 600 ) ; break ;
		case 'Video'		: oCommand = new FCKDialogCommand( 'Video'		, FCKLang.DlgVideoTitle	, 'dialog/fck_video.php'		, 500, 600 ) ; break ;
