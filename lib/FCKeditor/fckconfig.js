...
FCKConfig.EditorAreaCSS = '/backoffice/cms/utils/get_wysiwyg_css.php' ;
...
FCKConfig.ToolbarSets["Email"] = [
	...
	'/',
	['Bold','Italic','Underline','StrikeThrough','-','TextColor','-','OrderedList','UnorderedList','-','Link','Unlink']
] ;
...
FCKConfig.StylesXmlPath		= '/backoffice/cms/utils/get_wysiwyg_stylexml.php' ;
...
FCKConfig.FlashBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Connector=connectors/php/connector.php?Type=Flash' ;
...
FCKConfig.ImageBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Connector=connectors/php/connector.php?Type=Image' ;
