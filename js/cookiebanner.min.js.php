<?php
	...
	if ( defined("DEF_JS_COOKIESBAN_TRANSLATE_USE") && DEF_JS_COOKIESBAN_TRANSLATE_USE  ) {
...
if ( $bShowCookie ) {
	...
	/*$buffer = preg_replace('#Ce site utilise des cookies pour vous offrir le meilleur service. En continuant, vous acceptez de recevoir nos cookies.#is', $translator->getText("Ce site utilise des cookies pour vous offrir le meilleur service. En continuant, vous acceptez de recevoir nos cookies.", $_SESSION["id_langue"]), $buffer); 
	
	$buffer = preg_replace('#En savoir plus#is', $translator->getText("En savoir plus", $_SESSION["id_langue"]), $buffer); 
	
	$buffer = preg_replace('#http://www.cnil.fr/vos-obligations/sites-web-cookies-et-autres-traceurs/#is', $translator->getText("http://www.cnil.fr/vos-obligations/sites-web-cookies-et-autres-traceurs/", $_SESSION["id_langue"]), $buffer); */
	echo $myscript; 
	 
	 
}
// sinon on supprime la bannière cookie
// cas 1 : version russe
// cas 2 : l'adresse ip ne se trouve pas dans la zone ue
else {
	   
	//$buffer = preg_replace('#<script([^>]*)cookiebanner([^>]*)><\/script>.#ismU', "" , $buffer);    
