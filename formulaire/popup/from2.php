...
<script language="javascript"><!--
	function makeit() {
		...
		txtLine+= '<input type="text" name="fromperso_<?php echo noAccent($_GET["nomchamp"]); ?>" id="fromperso_<?php echo noAccent($_GET["nomchamp"]); ?>" ';
		...
		txtLine+= 'errorMsg="Le champ <?php echo noAccent($_GET["nomchamp"]); ?>  doit respecter la syntaxe d un email" pattern="'+ pattern +'" class="awsformfield">';
		txtLine+= '</td></tr>';	
