...
(function() {
	...
	var attributesMap = {
		...
		thumb: [ {
			type: ATTRTYPE_OBJECT, name: 'thumb'
		}, {
			type: ATTRTYPE_EMBED, name: 'thumb'
		}]
	};
	...
	CKEDITOR.dialog.add( 'aws_videoDialog', function( editor ) {
		...
		return {
			title: editor.lang.aws_video.title,
			minWidth: 420,
			minHeight: 310,
			onShow: function() {
			...
			contents: [
						...
						children : [
							...
							},
							{
								...
								filebrowser :
								{
									action : 'Browse',
									target: 'info:thumb',
									url: editor.config.filebrowserAws_videoDialogUploadUrl 
								},
				...
				{
					type: 'fieldset',
					label: CKEDITOR.tools.htmlEncode( editor.lang.aws_video.flashvars ),
					children: [
						{
						type: 'vbox',
						padding: 0,
